...
data:
  ...
  bundledCode: "#line 1 \"test/Library_Checker/Convolution/Convolution_Mod_1097.test.cpp\"\
    ...
    \ ayuna\n#line 6 \"test/Library_Checker/Convolution/Convolution_Mod_1097.test.cpp\"\
    \n\nusing namespace std;\n\nint main() {\n  cin.tie(0);\n  ios::sync_with_stdio(0);\n\
    \  int n, m;\n  cin >> n >> m;\n  ayuna::FormalPowerSeries<ayuna::modint1000000007>\
    \ a(n), b(m);\n  for (int i = 0; i < n; i++) {\n    int k;\n    cin >> k;\n  \
    \  a[i] = k;\n  }\n  for (int i = 0; i < m; i++) {\n    int k;\n    cin >> k;\n\
  ...
  verifiedWith: []
documentation_of: test/Library_Checker/Convolution/Convolution_Mod_1097.test.cpp
layout: document
redirect_from:
- /verify/test/Library_Checker/Convolution/Convolution_Mod_1097.test.cpp
- /verify/test/Library_Checker/Convolution/Convolution_Mod_1097.test.cpp.html
