...
data:
  ...
  bundledCode: "#line 1 \"test/Library_Checker/Polynomial/Pow_of_Formal_Power_Series.test.cpp\"\
    ...
    \  int n;\n  long long m;\n  cin >> n >> m;\n  ayuna::FormalPowerSeries<ayuna::modint998244353>\
    \ f(n);\n  for (int i = 0; i < n; i++) {\n    int a;\n    cin >> a;\n    f[i]\
    \ = a;\n  }\n  auto g = f.pow(m);\n  for (int i = 0; i < n; i++) {\n    if (i)\
    \ cout << \" \";\n    cout << g[i].val();\n  }\n  cout << endl;\n}\n"
...
layout: document
redirect_from:
- /verify/test/Library_Checker/Polynomial/Pow_of_Formal_Power_Series.test.cpp
- /verify/test/Library_Checker/Polynomial/Pow_of_Formal_Power_Series.test.cpp.html
