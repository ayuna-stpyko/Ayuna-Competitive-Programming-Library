...
data:
  ...
  bundledCode: "#line 1 \"test/Library_Checker/Polynomial/Log_of_Formal_Power_Series.test.cpp\"\
    ...
    \ <class T, std::enable_if_t<std::is_integral_v<T>, int> = 0>\n  constexpr modint(T\
    \ v) {\n    ll x = (ll)(v % (ll)(m));\n    if(x < 0)\n      x += m;\n    _v =\
    ...
    \ ayuna\n#line 6 \"test/Library_Checker/Polynomial/Log_of_Formal_Power_Series.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/Library_Checker/Polynomial/Log_of_Formal_Power_Series.test.cpp
- /verify/test/Library_Checker/Polynomial/Log_of_Formal_Power_Series.test.cpp.html
